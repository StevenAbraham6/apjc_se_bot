  ...
  (0, _createClass3.default)(Meeting, [{
    ...
    value: function addMedia() {
      ...
      return _util2.default.validateOptions(options).then(function () {
        if (!_this29.mediaProperties.peerConnection) {
          _this29.mediaProperties.setMediaPeerConnection(_util4.default.createPeerConnection());
        }
    ...
    value: function updateAudio(options) {
      ...
      return _util2.default.validateOptions({ sendAudio: sendAudio, localStream: stream }).then(function () {
        ...
        if (_this31.mediaProperties.mediaDirection) {
          ...
          _this31.mediaProperties.mediaDirection = {};
        }
        ...
        _this31.audio = _this31.audio || _audio2.default.create(_this31.mediaProperties.mediaDirection, _this31);
      });
    }
    ...
    value: function updateVideo(options) {
      ...
      return _util2.default.validateOptions({ sendVideo: sendVideo, localStream: stream }).then(function () {
        ...
        _this32.video = _this32.video || _video2.default.create(_this32.mediaProperties.mediaDirection, _this32);
      });
    }
