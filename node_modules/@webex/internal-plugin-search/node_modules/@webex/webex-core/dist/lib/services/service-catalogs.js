...
var ServiceCatalogs = function () {
   ...
   */
  function ServiceCatalogs() {
    (0, _classCallCheck3.default)(this, ServiceCatalogs);
  ...
  (0, _createClass3.default)(ServiceCatalogs, [{
    key: 'clear',
    ...
    value: function filterCatalog() {
      ...
      var catalogs = (Array.isArray(catalog) ? catalog : [catalog]).map(function (catalogId) {
        return ServiceCatalogs.mapCatalogName({
          id: catalogId,
    ...
    value: function filterPriority(priority) {
      return priority ? this.hosts.reduce(function (filteredHosts, currentHost) {
        ...
        var foundHostCatalogPriority = ServiceCatalogs.mapCatalogName({
        ...
        var currentHostCatalogPriority = ServiceCatalogs.mapCatalogName({
    ...
    value: function filterService() {
      ...
      return services.length > 0 ? this.hosts.filter(function (host) {
        return service.includes(host.service);
      }) : [].concat((0, _toConsumableArray3.default)(this.hosts));
    }
    ...
    value: function find() {
      ...
      return this.hosts.filter(function (host) {
        return _this.filterActive(active).includes(host) && _this.filterCatalog(catalog).includes(host) && _this.filterCluster(cluster).includes(host) && _this.filterLocal(local).includes(host) && _this.filterPriority(priority).includes(host) && _this.filterService(service).includes(host);
      });
    }
    ...
    value: function mapRemoteCatalog(_ref3) {
      ...
      var catalogIndex = ServiceCatalogs.mapCatalogName({
        id: catalog,
        type: _constants.SERVICE_CATALOGS_ENUM_TYPES.STRING
      });
...
exports.default = ServiceCatalogs;
//# sourceMappingURL=service-catalogs.js.map
